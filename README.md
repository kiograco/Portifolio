...
Gosto de projetos que resolvem um problema de negócio real: multiempresa, pagamentos, integrações de mensageria, autenticação e arquitetura bem pensada, não só um CRUD bonito.
...
`TypeScript` `React` `PHP` `Java / Spring Boot` `Angular` `Supabase / PostgreSQL` `Docker`
